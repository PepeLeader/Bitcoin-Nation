 ...
 */
export type CollectionCreatorResult = CallResult<
    {
        creator: Address;
    },
    OPNetEvent<never>[]
 ...
 */
export type AdminResult = CallResult<
    {
        admin: Address;
    },
    OPNetEvent<never>[]
...
export interface IBitcoinNationFactory extends IOP_NETContract {
    ...
    collectionCreator(collectionAddress: Address): Promise<CollectionCreatorResult>;
